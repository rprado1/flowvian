...
class SubtractTimeFromDateNode(BaseNode):
    ...
    def validate(self) -> list[str]:
        ...
        if not input_var:
            ...
            errors.append(
                f"subtract_time_from_date: input_var '{input_var}' must be a variable name or template"
            )
    ...
    def to_code(self, indent: int = 0) -> str:
        ...
        lines = [
            ...
            "        raise ValueError(f\"subtract_time_from_date: input variable '{_input_var_raw}' not found\")",
